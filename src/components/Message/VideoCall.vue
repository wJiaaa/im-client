    ...
    <div class="operation">
      ...
      <div class="step">
        ...
        <el-input v-model="offerSdp">
          <template #append>
            <el-button type="success" @click="copyToClipboard(offerSdp)"> 点击复制 </el-button>
          </template>
        </el-input>
      </div>
      <!-- step2 -->
      <div class="step">
        ...
        <p>
          用户 2将用户1 刚才生成的SDP offer 粘贴到下方，点击 "创建答案 "来生成SDP答案，然后将 SDP Answer 复制给用户 1。
        </p>
        ...
        <el-input v-model="answerSdp">
          <template #append>
            <el-button type="success" size="default" @click="copyToClipboard(answerSdp)"> 点击复制 </el-button>
          </template>
        </el-input>
      </div>
      <!-- step3 -->
